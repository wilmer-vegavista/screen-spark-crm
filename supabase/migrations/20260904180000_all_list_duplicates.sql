-- Adminöversikt: dubbletter per lista över hela systemet.
-- Returnerar för varje lista de uppgifter (företag/telefon/mejl) som även
-- förekommer hos en annan säljare (i dennes listor eller på order/offert).
-- Endast admin får resultat.
