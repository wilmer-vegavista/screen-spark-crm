      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border bg-card p-6 shadow-[var(--shadow-card)]">
          ...
          <Button variant="outline" className="w-full" onClick={onGoogle} disabled={loading}>
            <svg className="size-4 mr-2" viewBox="0 0 24 24"><path fill="#fff" d="M21.35 11.1H12v3.84h5.34c-.23 1.42-1.69 4.17-5.34 4.17-3.21 0-5.84-2.66-5.84-5.94S8.79 7.23 12 7.23c1.83 0 3.06.78 3.76 1.45l2.56-2.47C16.74 4.71 14.57 3.75 12 3.75 6.93 3.75 2.85 7.83 2.85 12.9s4.08 9.15 9.15 9.15c5.28 0 8.78-3.71 8.78-8.93 0-.6-.07-1.05-.18-1.5z" /></svg>
            Fortsätt med Google
          </Button>
        </div>
